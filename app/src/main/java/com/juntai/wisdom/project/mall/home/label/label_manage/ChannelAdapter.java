package com.juntai.wisdom.project.mall.home.label.label_manage;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<LabelListBean.LabelBean> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;

    public ChannelAdapter(Context context, ItemTouchHelper helper, List<LabelListBean.LabelBean> mMyChannelItems, List<LabelListBean.LabelBean> mOtherChannelItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.sell_item_my_channel_header, parent, false);
            ...
            case TYPE_MY:
                view = mInflater.inflate(R.layout.sell_item_my, parent, false);
            ...
            case TYPE_OTHER_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.sell_item_other_channel_header, parent, false);
                return new RecyclerView.ViewHolder(view) {
                };

            case TYPE_OTHER:
                view = mInflater.inflate(R.layout.sell_item_other, parent, false);
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        LabelListBean.LabelBean item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        LabelListBean.LabelBean item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        LabelListBean.LabelBean item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
    ...
    public List<LabelListBean.LabelBean> getmMyChannelItems() {
        return mMyChannelItems;
    }

    public List<LabelListBean.LabelBean> getmOtherChannelItems() {
