 ...
 */
public class NFOrderCommodityAdapter extends BaseQuickAdapter<OrderDetailBean.CommodityListBean, BaseViewHolder> {
    public NFOrderCommodityAdapter(int layoutResId) {
        super(layoutResId);
    }
